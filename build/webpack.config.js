...
module.exports = {
  ...
  plugins: [
    ...
    new CopyPlugin({
      patterns: [
        {
          from: getPath("src/web/components/banner/banner.html"),
          to: getPath("dist/web/components/banner/banner.html"),
          info: { minimized: true },
        },
        {
          from: getPath("src/web/layouts/layout.html"),
          to: getPath("dist/web/layouts/layout.html"),
          info: { minimized: true },
        },
        {
          from: getPath("src/feishu/feishu.py"),
          to: getPath("dist/feishu/feishu.py"),
          info: { minimized: true },
        },
      ],
    }),
